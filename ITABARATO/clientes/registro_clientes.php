...
//------------------------------------------------------//
	...
	$validado=1;//lo validamos de esta manera ya que el servicio de hosting y domnio son gratis y no teien la opcion de email
...
//verificamos que el email no este en la BD
	if(mysqli_num_rows($registros)==0){

	mysqli_query($conexion,"INSERT INTO clientes (nombre,apellidos,email,direccion,cp,estado,telefono,password,validado) VALUES ('$nombre','$apellidos','$email','$direccion','$cp','$estado','$telefono','$password',$validado)");
