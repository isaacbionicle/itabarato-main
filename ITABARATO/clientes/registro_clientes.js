...
function validarformulario(){
	...
	if(document.formregistro.nombre.value=="" || document.formregistro.apellidos.value=="" || document.formregistro.email.value=="" || document.formregistro.direccion.value=="" || document.formregistro.cp.value=="" || document.formregistro.estado
		.value=="" || document.formregistro.password1.value=="" || document.formregistro.password2.value==""){
